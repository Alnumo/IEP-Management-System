...
CREATE TABLE therapy_plans (
  ...
  total_price DECIMAL(10,2) GENERATED ALWAYS AS (total_sessions * price_per_session) STORED,
  discount_percentage DECIMAL(5,2) DEFAULT 0 CHECK (discount_percentage >= 0 AND discount_percentage <= 100),
  final_price DECIMAL(10,2) GENERATED ALWAYS AS (total_price * (1 - discount_percentage/100)) STORED,
  is_active BOOLEAN DEFAULT true,
